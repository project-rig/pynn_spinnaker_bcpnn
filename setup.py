...
def replace_local_hyperlinks(
        text,
        base_url="https://github.com/project-rig/pynn_spinnaker_bcpnn/blob/master/"
        ):
...
setup(
    name="pynn_spinnaker_bcpnn",
    version="0.1",
    packages=find_packages(),
    package_data={'pynn_spinnaker_bcpnn': ['binaries/*.aplx']},

    # Metadata for PyPi
    url="https://github.com/project-rig/pynn_spinnaker_bcpnn",
    author="University of Manchester",
    description="Plugin for PyNN SpiNNaker to allow models using Bayesian "
                "Confidence Propogation Neural Network (BCPNN) "
                "learning rule to be simulated on SpiNNaker",
    ...
    install_requires=["pynn>=0.8", "rig>=1.1.0, <2.0.0",
                      "bitarray>=0.8.1, <1.0.0", "pynn_spinnaker>=0.2"],
